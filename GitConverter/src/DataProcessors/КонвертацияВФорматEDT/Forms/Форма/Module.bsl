...
Процедура ХранилищеПриИзмененииНаСервере()
	...
	Если ЗначениеЗаполнено(Хранилище) Тогда
		...
		ВерсияПроектаEDT = "";
		Версия = РеквизитыХранилища.ВерсияПлатформыХранилища;
...
Процедура ОтключитьХранилище()
	...
	Запрос.Текст =
		...
		|	И (ВерсииХранилища.Состояние = ЗНАЧЕНИЕ(Перечисление.СостоянияВерсии.ЗагружаетсяВEDT)
	...
	Пока ВыборкаДетальныеЗаписи.Следующий() Цикл
		...
		ВерсияОбъект.Состояние = Перечисления.СостоянияВерсии.ПолученCF;
