...
Процедура ПриЧтенииНаСервере(ТекущийОбъект)
	...
	Если ЭтоWindowsСервер Тогда
		Элементы.ПутьКВерсиямПлатформыНаСервере.СписокВыбора.Добавить("C:\Program files\1cv8\%ВерсияПлатформыХранилища%\bin");
		Элементы.ПутьКВерсиямПлатформыНаСервере.СписокВыбора.Добавить(
			"C:\Program files (x86)\1cv8\%ВерсияПлатформыХранилища%\bin");
	Иначе
		// Это Linux
		Элементы.ПутьКВерсиямПлатформыНаСервере.СписокВыбора.Добавить("/opt/1cv8/x86_64/%ВерсияПлатформыХранилища%/");
