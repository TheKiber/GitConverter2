...
Процедура ПараметрыКаталогаИсполняемогоФайлаНаСервере(Параметры) Экспорт
	...
	Если ЗначениеЗаполнено(ПутьКВерсиямПлатформыНаСервере) Тогда
		...
		КонецЕсли;
		ПутьКВерсиямПлатформыНаСервере = СтрЗаменить(ПутьКВерсиямПлатформыНаСервере, "%ВерсияПлатформы%", Параметры.ВерсияПлатформыХранилища);
...
Процедура СформироватьОтчетПоВерсиямХранилища(Параметры) Экспорт
	...
	ВерсияПлатформыДоНачала = Параметры.ВерсияПлатформы;
	КаталогИсполняемогоФайлаДоНачала = Параметры.КаталогИсполняемогоФайла;
	
	Если ЗначениеЗаполнено(ВерсииПлатформыХранилища) И ВерсияПлатформыДоНачала <> ВерсииПлатформыХранилища Тогда
	...
	Параметры.ВерсияПлатформы = ВерсияПлатформыДоНачала;
	Параметры.КаталогИсполняемогоФайла = КаталогИсполняемогоФайлаДоНачала;
...
Процедура ДополнитьКонтекстРаботыСВерсией(Контекст) Экспорт
	...
	Если ЗначениеЗаполнено(ПутьКВерсиямПлатформы) Тогда
		ПутьКВерсииПлатформы = СтрЗаменить(ПутьКВерсиямПлатформы, "%ВерсияПлатформы%", Контекст.ВерсияПлатформыХранилища);
