...
// Выполняет метод общего модуля в фоновом задании. Модули менеджеров не поддерживаются.
//
// Параметры:
//   Ключ - Строка - Ключ уникальности задания. Если задание с таким ключом и именем метода уже выполняется,
//       то новое не будет запущено.
//   ИмяМетода - Строка - Полное имя вызываемого метода в формате "ИмяОбщегоМодуля.ИмяМетодаВМодуле".
//   Представление - Строка - Наименование фонового задания для администратора.
//   Параметр1 - Произвольный - 1й параметр метода. Обязательный.
//   Параметр2 - Произвольный - 2й параметр метода. Необязательный.
//   Параметр3 - Произвольный - 3й параметр метода. Необязательный.
//
// Возвращаемое значение:
//   ФоновоеЗадание
//
