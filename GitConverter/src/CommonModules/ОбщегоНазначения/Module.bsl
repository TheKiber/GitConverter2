...
Функция ФайлыНаОдномУстройстве(ПутьККаталогу1, ПутьККаталогу2) Экспорт
...
//
Процедура ЗаписатьВЛог(Знач ИмяФайлаЛога, Знач Уровень, Знач ИмяСобытия, Знач Текст, Знач Кодировка = Неопределено, Знач Процент = Неопределено) Экспорт
	УровеньЖурнала = УровеньЖурнала(Уровень);
...
//
Функция ИменаЯзыковКонфигурации(Знач СтруктураDOM) Экспорт
