...
Функция ЭтоВерсияПлатформы8315ИлиВыше(Знач ВерсияПлатформыХранилища)
	
	Возврат ОбщегоНазначенияКлиентСервер.СравнитьВерсии(ВерсияПлатформыХранилища, "8.3.15.0") > 0;
